...
public class stok_barang extends javax.swing.JFrame {
    ...
    public stok_barang() {
        ...
        table_barang.setModel(table1);
        table1.addColumn("Kode Barang");
        table1.addColumn("Nama Barang");
    ...
    private void table_barangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_barangMouseClicked
        ...
        String kode = table1.getValueAt(row, 0).toString();
        menu.txt_kodebarang2.setText(kode);
        
        String nama = table1.getValueAt(row, 1).toString();
        menu.txt_namabarang2.setText(nama);
        
        String harga = table1.getValueAt(row, 2).toString();
        menu.txt_harga2.setText(harga);
        
        String Stok = table1.getValueAt(row, 3).toString();
        menu.stok.setText(Stok);
